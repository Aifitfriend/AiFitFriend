...
def main(_):
  ...
  output_dir = "/Users/dharrensandhi/PycharmProjects/model_1_keypoint_detection/tfrecord"
  ...
  testdev_output_path = os.path.join(output_dir, 'coco_testdev.record')

  _create_tf_record_from_coco_annotations(
      '/Users/dharrensandhi/PycharmProjects/model_1_keypoint_detection/train_data.json',
      '/Users/dharrensandhi/fiftyone/coco-2017/validation/data',
      train_output_path,
      FLAGS.include_masks,
      num_shards=100,
      keypoint_annotations_file='/Users/dharrensandhi/PycharmProjects/model_1_keypoint_detection/train_data.json',
      densepose_annotations_file=FLAGS.train_densepose_annotations_file,
      remove_non_person_annotations=True,
      remove_non_person_images=FLAGS.remove_non_person_images)
  _create_tf_record_from_coco_annotations(
      '/Users/dharrensandhi/PycharmProjects/model_1_keypoint_detection/validation_data.json',
      '/Users/dharrensandhi/fiftyone/coco-2017/validation/data',
      val_output_path,
      FLAGS.include_masks,
      num_shards=50,
      keypoint_annotations_file='/Users/dharrensandhi/PycharmProjects/model_1_keypoint_detection/validation_data.json',
